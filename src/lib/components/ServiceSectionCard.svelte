...
>
	...
	<div class="relative h-64 overflow-hidden">
		...
		<div class="absolute bottom-4 left-4 right-4">
			<div
				class="w-12 h-12 rounded-full backdrop-blur-sm flex items-center justify-center mb-3 shadow-lg"
			>
	...
	<div class="p-8">
		...
		<div
			class="mt-6 flex items-center gap-2 text-sage-dark font-medium text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform -translate-x-2.5 group-hover:translate-x-0"
		> 
			<a href={resolve('/(app)/services')} class="flex items-center gap-2">
				<span>Servicios</span>

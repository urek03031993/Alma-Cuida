...
{#if open}
	<dialog 
		...
		class="backdrop:bg-gray-900/50 open:flex flex-col w-full rounded-lg divide-y text-on-background border-gray-300 dark:border-gray-700 divide-gray-300 dark:divide-gray-700 bg-background dark:bg-cream pointer-events-auto my-auto mx-auto max-w-lg"
	>	
